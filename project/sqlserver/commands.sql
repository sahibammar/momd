...
CREATE TABLE momd..FamilyFile (
    ...
    FOREIGN KEY (EntryPlaceCode) REFERENCES momd..MohafathaLookup (MohafathaCode) ON UPDATE CASCADE,
...
CREATE TABLE momd..FamilyMembers (
    ...
    FOREIGN KEY (MemberIdentifier) REFERENCES momd..Member(Identifier) ON UPDATE CASCADE
)
GO
